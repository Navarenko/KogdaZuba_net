...
class AitMigration {
	...
	public static function init(){
		...
		self::$compatibleThemes = array('cityguide', 'directory2', 'eventguide', 'foodguide');
	...
	public static function adminPage(){
		echo '<div class="wrap">';
			echo '<div id="ait-migration-page" class="ait-admin-page">';
						...
						echo '<div class="ait-options-page-content">';
							echo '<div class="ait-options-sidebar">';
								echo '<div class="ait-options-sidebar-content">';
									echo '<h3 class="ait-options-sidebar-title">'.__('Migration', 'ait-directory-migrations').'</h3>';
							...
							echo '<div class="ait-options-content">';
								echo '<div class="ait-options-content-header">';
									echo '<h1><span id="ait-options-panel-title">'.__('Migration', 'ait-directory-migrations').'</span></h1>';
								echo '</div>';
													...
													if(count($commands) != 0){
														...
														if(!is_array($settings)){
															...
															echo '<div class="ait-options-section">';
																...
																echo '</div>';
															echo '</div>';
															echo '<div class="ait-options-section  ait-sec-title">';
																...
																echo '<div class="ait-backup-action">';
																	echo '<a href="#" id="saveSettings" class="ait-button button button-primary"><span class="button-title">'.__('Save Settings','ait-directory-migrations').'</span></a>';
																echo '</div>';
														} else {
															echo '<div class="ait-options-section">';
																...
																echo '<div class="ait-opt-container">';
																	echo '<div class="ait-opt-wrap">';
																		...
																		echo '<div class="ait-loader loader-hidden" data-unit="%" data-value="0"><p class="loader-status"><span class="loader-value">0</span><span class="loader-unit">%</span></p><div class="loader-bar"></div></div>';

																		echo '<div class="ait-backup-action">';
																			echo '<a href="#" id="migration-start" class="ait-button button button-primary">'.__('Migrate','ait-directory-migrations').'</a>';
															...
															echo '<div class="ait-opt-container">';
																echo '<div class="ait-opt-wrap">';
																	...
																	echo '<div class="alert alert-success">';
																		...
																		echo '<strong>'.__('Congratulations!','ait-directory-migrations').'</strong> '.$text;
																	echo '</div>';
