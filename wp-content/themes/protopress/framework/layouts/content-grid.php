...
<article id="post-<?php the_ID(); ?>" <?php post_class('col-md-6 col-sm-6 grid'); ?>>
		...
		<div class="out-thumb col-md-8 col-sm-8">
			<header class="entry-header">
				<h2 class="entry-title title-font title_in_articles_feed"><a href="<?php the_permalink(); ?>" rel="bookmark"><?php the_title(); ?></a></h2>
...
<!--				<span class="readmore"><a class="hvr-underline-from-center" href="--><?php //the_permalink() ?><!--">--><?php //_e('Подробнее','protopress'); ?><!--</a></span>-->
			</header><!-- .entry-header -->
		</div><!--.out-thumb-->
